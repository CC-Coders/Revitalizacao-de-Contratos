...
function createDataset(fields, constraints, sortFields) {
    ...
    WHERE\
        ...
        myQuery =
            //  ID_TCNT_AUXILIAR vem do cabeçalho (TCNT_AUXILIAR.ID)
            "SELECT TCNT.CODCOLIGADA, TCNT.IDCNT, TCNT.CODIGOCONTRATO, TCNT_AUXILIAR.ID AS ID_TCNT_AUXILIAR, TCNT_AUXILIAR_ITENS.NSEQITEMCNT, TCNT_AUXILIAR.IS_RETENCAO, TCNT_AUXILIAR.PERCENT_RETENCAO, FCFO.CGCCFO, FCFO.NOMEFANTASIA as FORNECEDOR, TCNT.VALORCONTRATO, TCNT_AUXILIAR_ITENS.VALOR, TCNT.NOME AS DESCRICAOCONTRATO,\
